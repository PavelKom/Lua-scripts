...
function Peripheral.__isInCubic_3(self, w,h,d)
	return self.isPlayersInCubic({w=w,h=h,d=d})
end
function Peripheral.__isInCubic_4(self, w,h,d, username)
...
function Peripheral.__isInCoords_10(self, pos1, x2, y2, z2, username)
	return Peripheral.__isInCoords_2(self, pos1, {x2, y2, z2}, username)
end
function Peripheral.__isInCoords_11(self, x1, y1, z1, x2, y2, z2, isWHD)
...
function Peripheral.__isInCoords_12(self, pos1, x2, y2, z2, isWHD, username)
	return Peripheral.__isInCoords_4(self, pos1, {x2, y2, z2}, isWHD, username)
end

local isIn = Overload()
Overload.reg(isIn, Peripheral.__isInRange_1, {},0)
Overload.reg(isIn, Peripheral.__isInRange_2, {},0,"")

Overload.reg(isIn, Peripheral.__isInCubic_1, {},{})
Overload.reg(isIn, Peripheral.__isInCubic_2, {},{},"")
Overload.reg(isIn, Peripheral.__isInCubic_3, {},0,0,0)
Overload.reg(isIn, Peripheral.__isInCubic_4, {},0,0,0,"")

Overload.reg(isIn, Peripheral.__isInCoords_1, {},{},{})
Overload.reg(isIn, Peripheral.__isInCoords_2, {},{},{},"")
Overload.reg(isIn, Peripheral.__isInCoords_3, {},{},{},true)
Overload.reg(isIn, Peripheral.__isInCoords_4, {},{},{},true,"")
Overload.reg(isIn, Peripheral.__isInCoords_5, {},{},0,0,0)
Overload.reg(isIn, Peripheral.__isInCoords_6, {},{},0,0,0,"")
Overload.reg(isIn, Peripheral.__isInCoords_7, {},{},0,0,0,true)
Overload.reg(isIn, Peripheral.__isInCoords_8, {},{},0,0,0,true,"")
Overload.reg(isIn, Peripheral.__isInCoords_9, {},0,0,0,0,0,0)
Overload.reg(isIn, Peripheral.__isInCoords_10, {},0,0,0,0,0,0,"")
Overload.reg(isIn, Peripheral.__isInCoords_11, {},0,0,0,0,0,0,true)
Overload.reg(isIn, Peripheral.__isInCoords_12, {},0,0,0,0,0,0,true,"")
...
function Peripheral.__getInCubic_3(self, w,h,d)
	return self.getPlayersInCubic({w=w,h=h,d=d})
end
function Peripheral.__getInCubic_4(self, w,h,d, username)
...
function Peripheral.__getInCoords_10(self, pos1, x2, y2, z2, username)
	return Peripheral.__getInCoords_2(self, pos1, {x2, y2, z2}, username)
end
...
function Peripheral.__getInCoords_12(self, pos1, x2, y2, z2, getWHD, username)
	return Peripheral.__getInCoords_4(self, pos1, {x2, y2, z2}, getWHD, username)
end

local getIn = Overload()
Overload.reg(getIn, Peripheral.__getInRange_1, {},0)
Overload.reg(getIn, Peripheral.__getInRange_2, {},0,"")

Overload.reg(getIn, Peripheral.__getInCubic_1, {},{})
Overload.reg(getIn, Peripheral.__getInCubic_2, {},{},"")
Overload.reg(getIn, Peripheral.__getInCubic_3, {},0,0,0)
Overload.reg(getIn, Peripheral.__getInCubic_4, {},0,0,0,"")

Overload.reg(getIn, Peripheral.__getInCoords_1, {},{},{})
Overload.reg(getIn, Peripheral.__getInCoords_2, {},{},{},"")
Overload.reg(getIn, Peripheral.__getInCoords_3, {},{},{},true)
Overload.reg(getIn, Peripheral.__getInCoords_4, {},{},{},true,"")
Overload.reg(getIn, Peripheral.__getInCoords_5, {},{},0,0,0)
Overload.reg(getIn, Peripheral.__getInCoords_6, {},{},0,0,0,"")
Overload.reg(getIn, Peripheral.__getInCoords_7, {},{},0,0,0,true)
Overload.reg(getIn, Peripheral.__getInCoords_8, {},{},0,0,0,true,"")
Overload.reg(getIn, Peripheral.__getInCoords_9, {},0,0,0,0,0,0)
Overload.reg(getIn, Peripheral.__getInCoords_10, {},0,0,0,0,0,0,"")
Overload.reg(getIn, Peripheral.__getInCoords_11, {},0,0,0,0,0,0,true)
Overload.reg(getIn, Peripheral.__getInCoords_12, {},0,0,0,0,0,0,true,"")
