...
function Peripheral:new(name)
	local self, wrapped = getset.VALIDATE_PERIPHERAL(name, Peripheral, 'Modem')
...
lib.Modem=setmetatable(Peripheral,{__call=Peripheral.new,__type = "peripheral",__subtype="modem",})
lib=setmetatable(lib,{__call=Peripheral.new,__type = "library",__subtype="Modem",})
