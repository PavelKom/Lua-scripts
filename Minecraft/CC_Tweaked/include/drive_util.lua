...
function Peripheral:new(name)
	local self, wrapped = getset.VALIDATE_PERIPHERAL(name, Peripheral, 'Drive')
...
lib.Drive=setmetatable(Peripheral,{__call=Peripheral.new,__type = "peripheral",__subtype="drive",})
lib=setmetatable(lib,{__call=Peripheral.new,__type = "library",__subtype="Drive",})
