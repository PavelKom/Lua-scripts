...
function Peripheral:new(name)
	local self, wrapped = getset.VALIDATE_PERIPHERAL(name, Peripheral, 'ManaPool')
...
lib.ManaPool=setmetatable(Peripheral,{__call=Peripheral.new,__type = "peripheral",__subtype="manaPool",})
lib=setmetatable(lib,{__call=Peripheral.new,__type = "library",__subtype="ManaPool",})
