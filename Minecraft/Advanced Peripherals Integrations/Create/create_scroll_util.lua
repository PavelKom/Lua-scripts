...
function Peripheral:new(name)
	local self, wrapped = getset.VALIDATE_PERIPHERAL(name, 'scrollBehaviourEntity', 'Create Scroll', Peripheral)
...
lib.CreateScroll=setmetatable(Peripheral,{__call=Peripheral.new})
