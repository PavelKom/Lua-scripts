...
function Peripheral:new(name)
	local self, wrapped = getset.VALIDATE_PERIPHERAL(name, 'redstoneProbe', 'Redstone Probe', Peripheral)
...
lib.RedstoneProbe=setmetatable(Peripheral,{__call=Peripheral.new})
