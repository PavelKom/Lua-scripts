...
function Peripheral:new(name)
	local self, wrapped = getset.VALIDATE_PERIPHERAL(name, Peripheral, 'Redstone Wire Connector')
...
lib.RedstoneWireConnector=setmetatable(Peripheral,{__call=Peripheral.new,__type = "peripheral",__subtype="redstoneConnector",})
lib=setmetatable(lib,{__call=Peripheral.new,__type = "library",__subtype="RedstoneWireConnector",})
